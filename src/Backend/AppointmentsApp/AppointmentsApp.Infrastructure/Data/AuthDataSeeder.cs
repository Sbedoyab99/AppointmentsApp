                ...
                if (!await context.BusinessProfiles.AnyAsync())
                {
                    var profiles = new List<BusinessProfile>
                    {
                        new()
                        {
                            ...
                            TradeName = "LosAmigos",
                            NormalizedTradeName = "LOSAMIGOS",
                            Description = "Barbería especializada en cortes clásicos y modernos para toda la familia.",
                            Phone = "+57 (1) 555-0100",
                            Address = "Carrera 7 #45-89, Bogotá, Colombia",
                        ...
                        new()
                        {
                            ...
                            TradeName = "DrGarcia",
                            NormalizedTradeName = "DRGARCIA",
                            Description = "Consultorio de medicina general con atención personalizada y con experiencia de más de 15 años.",
                            Phone = "+57 (1) 555-0200",
                            Address = "Avenida Paseo 123-A, Bogotá, Colombia",
                            TimeZone = "America/Bogota",
